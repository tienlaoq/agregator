	...
	r.Route("/api/v1", func(api chi.Router) {
		...
		api.Group(func(r chi.Router) {
			...
			r.Group(func(r chi.Router) {
				...
				r.With(ownerCabinet).Get("/owner/venues/{venueId}/schedule", venueHandler.GetVenueSchedule)
				r.With(ownerCabinet).Get("/owner/venues/{venueId}/booking-mode", venueHandler.GetOwnerBookingMode)
				r.With(ownerCabinet).Put("/owner/venues/{venueId}/booking-mode", venueHandler.SetOwnerBookingMode)
