...
import { SITE_PHONE, SITE_PHONE_HREF, SITE_EMAIL, SUPPORT_HOURS } from "@/lib/site-contacts"

// Реквизиты юрлица (плейсхолдеры) — только для футера, не выносим в общий модуль.
