...
const sbpSchema = z.object({
  ...
  sbp_bank_id: z.string().trim().min(1, "Укажите идентификатор банка СБП"),
});
          ...
          <Tabs defaultValue={method?.kind === "sbp" ? "sbp" : "bank_account"}>
            ...
            <TabsContent value="sbp" className="mt-4">
              ...
              >
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="sbp_bank_id">Банк СБП</Label>
                  <Input
                    id="sbp_bank_id"
                    placeholder="Идентификатор банка-участника СБП"
                    {...sbpForm.register("sbp_bank_id")}
                  />
